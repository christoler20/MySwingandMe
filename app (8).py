    ...
    if not st.session_state.speed_tier_unlocked:
        ...
        with col2:
            ...
            if st.button("⚡  UNLOCK SPEED LAB — $12.99/mo", use_container_width=True):
                ...
                st.success("Speed Lab unlocked! (Demo mode — connect Stripe for live billing.)")
                st.rerun()
            st.caption("Demo: this button simulates a successful subscription. In production it opens Stripe Checkout.")
