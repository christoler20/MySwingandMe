...
# ─────────────────────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="SwingDx · AI Golf Coach",
    page_icon="⛳",
    layout="wide",
...
if not st.session_state.disclaimer_accepted:
    ...
    <div class="disclaimer-wrap">
      ...
      <div class="sub">Please read before using SwingDx</div>
      <p><strong>SwingDx is a self-diagnostic tool.</strong> It is designed to help you understand
      ...
      <div class="points">
        <ul>
          <li>SwingDx is <strong>NOT a replacement for a qualified golf professional, PGA instructor, or certified coach</strong>.</li>
          ...
          <li>Anthropic and the creators of SwingDx are not liable for any injury, equipment expense, or performance outcome resulting from use of this app.</li>
        </ul>
      </div>
    ...
    with col_b:
        if st.button("✓  I UNDERSTAND — CONTINUE TO SWINGDX", use_container_width=True, type="primary"):
...
with st.sidebar:
    ...
    <div style="padding:.5rem 0 .8rem">
      <div style="font-family:'Bebas Neue',sans-serif;font-size:2rem;color:#F59E0B;letter-spacing:.1em;">⛳ SwingDx</div>
    ...
    <div style="background:#080E1A;border-left:3px solid #F59E0B;padding:.6rem .8rem;border-radius:4px;font-size:.72rem;color:#6B8BAF;line-height:1.5;">
      ...
      SwingDx is a self-diagnostic tool. It is <strong>not a substitute for a professional PGA/LPGA golf coach</strong>. Equipment recommendations are educational only — see a certified club fitter for real fitting decisions.
    </div>
    """, unsafe_allow_html=True)
...
if "Home" in page:
    st.markdown("""
    <div class="hero">
      <div class="hero-title">SWINGDX</div>
    ...
    if not st.session_state.baseline_complete:
        ...
        <div class="card card-warn">
          ...
          <p>Before any coaching or diagnosis can begin, SwingDx needs to see where you are right now.
...
# ─────────────────────────────────────────────────────────────────────────────
    ...
    <div class="card card-gold">
      <strong>Why baseline first?</strong> SwingDx uses your baseline to determine which foundational
    ...
    with tab_rec:
        ...
        with col_b:
            st.markdown("""
            **📋 How to use:**
            1. Open SwingDx on your **phone** browser
...
# ─────────────────────────────────────────────────────────────────────────────
    ...
    <div class="card card-green">
      ...
      video links, drill assignments, or files from your PGA/LPGA professional. The SwingDx AI coach
